        ...
        <div className="drawer-body">
          ...
          {!REVIEW_ONLY && <section className="drawer-section">
            ...
            <div className="drawer-row stack">
              ...
              <p className="help-tip" style={{ marginTop: 2 }}>
                已移动到主界面的 <strong>切割策略 · 模式 1</strong> 折叠里——和它驱动的剪切流程放一起，避免和 Mode 2 自己的 Whisper 池混淆。
              </p>
            </div>
          </section>}
          ...
          {!REVIEW_ONLY && <section className="drawer-section">
            ...
            <div className="drawer-row stack">
              <label>额外 Ollama 端点（多机并发）</label>
              <p className="help-tip" style={{ marginTop: 2 }}>
                已移动到主界面的 <strong>切割策略 · 模式 1</strong> 折叠里。模式 2 的 LLM 池也在那里独立配置，互不影响。
              </p>
            </div>
            <div className="drawer-row">
              <label>并发请求数</label>
